        ...
        >
          ...
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="w-16 h-16 bg-gradient-to-r from-purple-500 to-orange-500 rounded-lg flex items-center justify-center text-white hover:shadow-lg transition-all transform hover:scale-105"
            >
